					...
					<div class="col-lg-5">
						<div class="order_box">
							...
							<ul class="list">
                                ...
                                <li>
									<a href="#"><?php echo $row["name"]; ?>
										...
										<span class="last">₹<?php echo ($row["quantity"]*$row["cost"]); ?>.00</span>
									</a>
								</li>
                                <?php 
                                        }
							...
							<div class="payment_item">
								<p>Please check your order and proceed for payment to avoid any wrong transactions.</p>
							</div>
							<div class="payment_item active">
								<div class="radion_btn">
									<input type="radio" id="f-option6" name="" checked>
									<label for="f-option6" >Paypal </label>
									<img src="img/product/single-product/card.jpg" alt="">
									<div class="check"></div>
								</div>
								<p>PAY SAFELY USING PAYPAL.</p>
							</div>
							...
							<button class="main_btn" type="submit" href="javascript:{}" onclick="validate();">Proceed to Paypal</button>
						  
                        </div>
					</div>
				    <div class="col-lg-7">
						<h3>Billing Details</h3>
						<form class="row contact_form" action="phpfiles/placeorder.php" method="post" id="my_array_form" validate>
							...
							<div class="col-md-12 form-group p_star">
								<input type="number" class="form-control" id="postal" name="postal" placeholder="Postcode/ZIP" value="<?php if($postal!=0)echo $postal; ?>" required>
							</div>
                            
                            <INPUT TYPE="hidden" NAME="input_name" VALUE="<?= base64_encode(serialize($data)); ?>"/>
